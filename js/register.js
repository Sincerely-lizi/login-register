    ...
    return {
        ...
        event: function() {
            ...
            this.$loginBtn.onclick = function() {
                ...
                sendAjax('http://localhost:5555/0929-login/login-register/php/register.php', params);
            }
            this.$usernameInp.onchange = function(){
                ...
                sendAjax('http://localhost:5555/0929-login/login-register/php/check_username.php', params);
            }
        },
